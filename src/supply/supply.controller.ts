import { Body, Controller, Res ,Delete,Query ,Get, Param, Put, UsePipes, ValidationPipe, Headers,  BadRequestException, HttpException, HttpStatus, InternalServerErrorException, UseInterceptors, Req } from '@nestjs/common';
...
export class SupplyController {
  ...
  async getAllocatedSurveys(@Req() req:Request) {
    try {
      ...
      supIdToFind = 116  //TODO : remove this when we have token
